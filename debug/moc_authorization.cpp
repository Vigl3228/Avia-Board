...
QT_MOC_LITERAL(1, 7, 16), // "openRegistration"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 14), // "succesfulEntry"
QT_MOC_LITERAL(4, 40, 5), // "User*"
QT_MOC_LITERAL(5, 46, 15) // "on_sign_clicked"

    },
    "SignIn\0openRegistration\0\0succesfulEntry\0"
    "User*\0on_sign_clicked"
};
...
void SignIn::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->succesfulEntry((*reinterpret_cast< User*(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignIn::openRegistration)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SignIn::*)(User * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SignIn::succesfulEntry)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SignIn::openRegistration()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SignIn::succesfulEntry(User * _t1)
{
